...
import { appParams } from "@/lib/api-client";
  ...
  useEffect(() => {
    (async () => {
      ...
      try {
        ...
        // Gate on the server's auth result, not a client-only auth check:
        ...
        if (!data.authenticated) {
          ...
          // round-trip and the auth bootstrap would persist them into the freshly
